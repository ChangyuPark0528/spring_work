<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<script>
        window.onload = function() {
            ...
            //요청된 페이지의 번호와, 화면을 리셋할 것인지의 여부를 bool타입의 reset으로 받겠습니다.
            //비동기방식이기때문에 페이지가 계속 머물면서 댓글이 밑에 쌓입니다.
            //때에 따라서는 댓글을 계속 누적시키는것이아닌, 화면을 초기화 하고 새롭게 보여줘야 할 때가 있다.
            //reset -> true: 페이지를 리셋해서 새롭게 그려내기, reset -> false: 누적해서 쌓기
            function getList(pageNum, reset){
                console.log('getList() 호출됨')
                strAdd = ''; //새로운 내용을 작성하기 위햐 변수의 값을 비우기.
                ...
                .then(data => {
                    ...
                    //더 보기 버튼 배치 판단
                    //현재 페이지 번호 * 이번 요청으로 받은 댓글 수 > 전체 댓글 수 -> 더보기 없어도 됨.
                    ...
                    //replyList의 개수만큼 태그를 문자영 형태로 직접 그림.
            ...
            function parseTime(regDate) {
                ...
                //getTime() : 1970년 1월1일 자정을 기준으로 현재까지의 시간을 밀리초로 리턴.
