...
@Repository // 빈 등록 -> Service가 의존하는 객체기 때문에 등록.
public class ScoreRepositoryImpl implements IScoreRepository {
	...
	static {
		...
		Score stu2 = new Score(new ScoreRequestDTO("대길이", 77, 99, 87));
		Score stu3 = new Score(new ScoreRequestDTO("춘식이", 98, 66, 85));
	...
	@Override
	public List<Score> findAll() { //목록을 불러오는 메서드
	...
	@Override
	public void save(Score score) { //점수 등록 메서드
